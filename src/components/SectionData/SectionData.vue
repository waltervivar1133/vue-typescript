...
const { totalEmployees, currentPage } = useEmployeStore();
const startEmployee = (currentPage - 1) * 10 + 1;
const endEmployee = Math.min(currentPage * 10, totalEmployees);
